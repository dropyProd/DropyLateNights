...
@HiltViewModel
class TruckRouteCustomerViewModel @Inject constructor(
    private val app: DropyApp,
    private val updateTruckLocationUseCase: UpdateTruckLocationUseCase
) : ViewModel() {
    val uiState = MutableStateFlow(TruckRouteCustomerUiState())

    val truckRouteCustomerUiState: StateFlow<TruckRouteCustomerUiState> = uiState.asStateFlow()

    var appViewModel: AppViewModel? = null


    fun navigatewaterScanQr(
        ...
        /* viewModelScope.launch {
             truckStartTripViewModel.setPageState(true)
