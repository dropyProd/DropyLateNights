    ...
    fun createWaterVendor(context: Context, waterVendorDashViewModel: WaterVendorDashViewModel){
        viewModelScope.launch {
            addWaterVendorUseCase(
                ...
                description = "n/a",
                holidays_open = if (addWaterVendorUiState.value.operationHrState) true else addWaterVendorUiState.value.holidayState,
                operating_all_day = if (addWaterVendorUiState.value.operationHrState) true else addWaterVendorUiState.value.operationHrState,
                saturday_open = if (addWaterVendorUiState.value.operationHrState) true else addWaterVendorUiState.value.saturdayState,
                sunday_open = if (addWaterVendorUiState.value.operationHrState) true else addWaterVendorUiState.value.sundayState,
                weekday_opening_time =if (addWaterVendorUiState.value.operationHrState) "00:00:00" else addWaterVendorUiState.value.weekday_opening_time,
                weekday_closing_time = if (addWaterVendorUiState.value.operationHrState) "00:00:00" else addWaterVendorUiState.value.weekday_closing_time,
                saturday_opening_time = if (addWaterVendorUiState.value.operationHrState) "00:00:00" else addWaterVendorUiState.value.saturday_opening_time,
                saturday_closing_time = if (addWaterVendorUiState.value.operationHrState) "00:00:00" else addWaterVendorUiState.value.saturday_closing_time,
                sunday_opening_time = if (addWaterVendorUiState.value.operationHrState) "00:00:00" else addWaterVendorUiState.value.sunday_opening_time,
                sunday_closing_time = if (addWaterVendorUiState.value.operationHrState) "00:00:00" else addWaterVendorUiState.value.sunday_closing_time,
